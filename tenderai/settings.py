...
DEFAULT_FROM_EMAIL = os.environ.get('DJANGO_DEFAULT_FROM_EMAIL', 'TenderAI <no-reply@tenderai.local>')
TENDERAI_PUBLIC_URL = os.environ.get('TENDERAI_PUBLIC_URL', '').strip()
